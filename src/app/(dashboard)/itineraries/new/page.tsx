...
export default function NewCustomItineraryPage() {
  ...
  const handleImportData = (p: any) => {
    ...
    if (p.flightPrice) setFlightPrice(p.flightPrice.toString());
    if (p.landCost) setLandCost(p.landCost.toString());
  ...
  // Stay helpers
  function addStay() { setStays([...stays, { _key: Date.now(), name: "", rating: "", nights: 0, roomType: "", rooms: 1, checkIn: "", checkOut: "", address: "", confirmationNo: "", amenities: [], remark: "", showRemarkToCustomer: false }]); }
