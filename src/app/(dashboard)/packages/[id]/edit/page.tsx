      ...
      if (p) {
        ...
        setItinerary(
          p.itinerary && p.itinerary.length > 0
            ? p.itinerary.map((d: { day?: number; title?: string; description?: string; activities?: (string | DayActivityItem)[]; meals?: string[]; accommodation?: string; images?: string[] }, i: number) => ({
                day: d.day || i + 1,
                title: d.title || "",
